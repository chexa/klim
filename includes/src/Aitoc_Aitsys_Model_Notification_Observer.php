...
class Aitoc_Aitsys_Model_Notification_Observer extends Aitoc_Aitsys_Abstract_Model
{
    ...
    {
        $news = Mage::getModel('aitsys/notification_news');
        /* @var $news Aitoc_Aitsys_Model_Notification_News */
        $news->loadData();
        
        $important = Mage::getModel('aitsys/notification_important');
        /* @var $news Aitoc_Aitsys_Model_Notification_Important */
        $important->loadData();
    }
    ...
    {
        return Mage::getSingleton('aitsys/notification_store');
    }
