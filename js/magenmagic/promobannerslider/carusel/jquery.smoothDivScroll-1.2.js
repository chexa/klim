...
(function ($) {
	...
	$.widget("thomaskahn.smoothDivScroll", {
		...
		_create: function () {
			...
			el.data("wrapList", el.parent());
			el.data("wrapWidth", el.parent().width());
			...
			el.data("hotSpotWidth", el.parent().width() / 2);
            ...
            function checkForLeft(element, e)
            {
                var posX = $(element).offset().left;
                var clientX = e.pageX;
                if ( ( clientX - posX ) > el.data("wrapWidth") / 2 ) return false;
                return true;
            }

            function checkForRight(element, e)
            {
                var posX = $(element).offset().left;
                var clientX = e.pageX;

                var bool1 = clientX > posX + el.data("wrapWidth");
                var bool2 = clientX < posX + el.data("wrapWidth") / 2 + 3;
			...
			*****************************************/
			...
			el.data("scrollWrapper").bind("mousemove", function (e) {

                if ( checkForRight(this, e) )
                {
                    //RIGHT
                    var posX = el.data("wrapWidth") / 2  + 3;

                    var x = e.pageX - (posX + el.data("scrollerOffset").left);
			...
			el.data("scrollWrapper").bind("mouseover", function (e) {
			...
			*****************************************/
            ...
            el.data("wrapList").bind("mousemove", function (e) {
                  if ( checkForLeft(this, e) )
                  {
                        //var x = el.data("hotSpotWidth") - (e.pageX - el.data("scrollerOffset").left);
                        var x = ((0 + el.data("scrollerOffset").left + el.data("hotSpotWidth")) - e.pageX);
                        el.data("scrollXPos", Math.round((x / el.data("hotSpotWidth")) * o.hotSpotScrollingStep));
			...
			el.data("wrapList").bind("mouseover", function (e) {
		...
		/*	el.data("wrapList").bind("mousemove", function (e) {
                ...
                if ( checkForLeft(this, e) ) return false;
...
/*
            el.data("wrapList").bind("mouseout", function (e) {
