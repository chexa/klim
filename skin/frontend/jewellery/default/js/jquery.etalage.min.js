 ...
 */ (function (a) {
    a.fn.etalage = function (b) {
        ...
        a.each(this, function () {
            var aD = a(this);
            var cntrl = aD.prev();
            aD.wrap('<div class="zoomWrapper"></div>');

                //console.log(c.thumb_image_width);
                var cik = aD.find(".etalage_thumb_image").clone().appendTo('body').addClass('dlt').show().css({left:-9999, position:"absolute"});

                if ( cik.width() > cik.height() )
                {
                    if ( c.thumb_image_width > cik.width()  )
                     {
                         c.thumb_image_width = cik.width();
                         c.thumb_image_height = cik.height();
                     }
                    else
                    {
                        var cik2 = aD.find(".etalage_thumb_image").clone().appendTo('body').addClass('dlt').show().css({left:-9999, position:"absolute"});
                         cik2.width(c.thumb_image_width);
                         c.thumb_image_height = cik2.height();
                         cik2.remove();
                    }

                    if ( c.source_image_width > cik.width()  )
                     {
                         c.source_image_width = cik.width();
                         c.source_image_height = cik.height();
                     }
                    else
                    {
                        var cik3 = aD.find(".etalage_thumb_image").clone().appendTo('body').addClass('dlt').show().css({left:-9999, position:"absolute"});
                         cik3.width(c.source_image_width);
                         c.source_image_height = cik3.height();
                         cik3.remove();
                    }
                ...
                {
                     if ( c.thumb_image_height > cik.height()  )
                     {
                         c.thumb_image_height = cik.height();
                          c.thumb_image_width = cik.width();
                     }
                     ...
                     {
                         var cik2 = aD.find(".etalage_thumb_image").clone().appendTo('body').addClass('dlt').show().css({left:-9999, position:"absolute"});
                         cik2.height(c.thumb_image_height);
                         c.thumb_image_width = cik2.width();
                         cik2.remove();
                     }


                    if ( c.source_image_height > cik.height()  )
                     {
                         c.source_image_height = cik.height();
                         c.source_image_width = cik.width();
                     }
                    ...
                    {
                        var cik3 = aD.find(".etalage_thumb_image").clone().appendTo('body').addClass('dlt').show().css({left:-9999, position:"absolute"});
                         cik3.height(c.source_image_height);
                         c.source_image_width = cik3.width();
                         cik3.remove();
                    }
            ...
            if ( cntrl.is('.cntrZoom') )
            {
                cntrl.appendTo(parent);
                cntrl.show();
                cntrl.find('.ad-back').attr('onclick', aD.attr('id')+"_previous();");
                cntrl.find('.ad-forward').attr('onclick', aD.attr('id')+"_next();");
            }

            parent.wrap('<div class="zmBorder"></div>');
            var tTop = parent.height() / 2 - c.thumb_image_height / 2;
            var tWidth = parent.width() / 2 - c.thumb_image_width / 2;
            aD.css({
                'left' : tWidth,
                'top' : tTop
            });
            ...
            if (aD.is("ul") && aD.children("li")
                .length && aD.find("img.etalage_source_image")
                .length) {
                ...
                aD.addClass("etalage") //.addClass('ad-image-main')
                    .show();
                var v = aD.children("li")
                ...
                a.each(v, function (aX) {
					...
					/**START*/
							var cik = j.clone().appendTo('body').addClass('dlt').show().css({left:-9999, position:"absolute"});

							var CThumbWidth = 233;
							var CThumbHeight = 233;
							var CSourceWidth = 750;
							var CSourceHeight = 750;
							
						if ( cik.width() > cik.height() )
						{
							if ( CThumbWidth > cik.width()  )
							 {
								 CThumbWidth = cik.width();
								 CThumbHeight = cik.height();
							 }
							else
							{
								var cik2 = j.clone().appendTo('body').addClass('dlt').show().css({left:-9999, position:"absolute"});
								 cik2.width(CThumbWidth);
								 CThumbHeight = cik2.height();
								 cik2.remove();
							}

							if ( CSourceWidth > cik.width()  )
							 {
								 CSourceWidth = cik.width();
								 CSourceHeight = cik.height();
							 }
							else
							{
								var cik3 = j.clone().appendTo('body').addClass('dlt').show().css({left:-9999, position:"absolute"});
								 cik3.width(CSourceWidth);
								 CSourceHeight = cik3.height();
								 cik3.remove();
							}
					...
					else
						{
							 ...
							 {
								 var cik2 = j.clone().appendTo('body').addClass('dlt').show().css({left:-9999, position:"absolute"});
								 cik2.height(CThumbHeight);
								 CThumbWidth = cik2.width();
								 cik2.remove();
							 }


							if ( CSourceHeight > cik.height()  )
							 {
								 CSourceHeight = cik.height();
								 CSourceWidth = cik.width();
							 }
							...
							{
								var cik3 = j.clone().appendTo('body').addClass('dlt').show().css({left:-9999, position:"absolute"});
								 cik3.height(CSourceHeight);
								 CSourceWidth = cik3.width();
								 cik3.remove();
							}
                    ...
                    a0.data("id", aX)
                        .addClass("thumb_" + aX)
                        .attr("rel", CThumbWidth+"|"+CThumbHeight+"|"+CSourceWidth+"|"+CSourceHeight);
                    ...
                    if (aY.length) {
                        a0.find(".etalage_thumb_image")
                            .data("anchor", aY.attr("href"))
							.css({
								'height' : CThumbHeight,
								'width' : CThumbWidth
							})
                ...
                var ar = v.find(".etalage_thumb_image").show();
                  /*  .css({
               ...
               // })
                ...
                a.each(ar, function () {
					var rel = a(this).closest('li').attr('rel').split('|');
                    a(this)
                        .data("src", this.src).css({
							width: rel[0],
							height: rel[1]
						});
						
                });
                var aL = a('<li class="etalage_magnifier"><div><img /></div></li>')
                    .appendTo(aD),
                    Y = aL.children("div"),
                    h = Y.children("img");
                var D = a('<li class="etalage_icon">&nbsp;</li>')
                    .appendTo(aD);
                if (c.show_icon) {
                    D.show()
                }
                ...
                if (r !== "auto" && r && a(r)
                    ...
                    I = a(r)
                        ...
                        .html('<div class="zmPict"><img class="etalage_zoom_img" /></div>')
                } else {
                    r = "auto";
                    I = a('<li class="etalage_zoom_area"><div class="zmPict"><img class="etalage_zoom_img" /></div></li>')
                        .appendTo(aD)
                }
                ...
                if (al) {
                    ak = a('<img class="etalage_zoom_preview" />')
                        .css({
                ...
                var ay = U.children(".etalage_zoom_img")
                    .css({
                    width: c.source_image_width,
                    height: c.source_image_height
                });
                ...
                if (c.show_descriptions) {
                    aw = a('<div class="etalage_description' + ((c.right_to_left) ? " rtl" : "") + '"></div>')
                        .prependTo(I)
                }
                var aM, l, aR, t, x, ag = c.small_thumbs;
                if (p > 1 || !c.smallthumb_hide_single) {
                    aM = a('<li class="etalage_small_thumbs"><ul></ul></li>')
                        .appendTo(aD);
                    l = aM.children("ul");
                    a.each(ar, function () {
                        var i = a(this);
                        O = i.data("src");
                        G = i.parents(".etalage_thumb")
                            .data("id");
                        a('<li><img class="etalage_small_thumb" src="' + O + '" /></li>')
                            .data("thumb_id", G)
                            .appendTo(l)
                    });
                    aR = l.children("li")
                    ...
                    if (p > ag) {
                        ...
                        G = v.eq(p - 1)
                            .data("id");
                        a('<li class="etalage_smallthumb_first"><img class="etalage_small_thumb" src="' + O + '" /></li>')
                            .data("src", O)
                            .data("thumb_id", G)
                            .prependTo(l)
                            .css({
                ...
                var aJ;
                if (e) {
                    aJ = a('<iframe marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="javascript:\'<html></html>\'"></iframe>')
                        .css({
                        position: "absolute",
                        zIndex: 1
                    })
                ...
                if (c.align === "right" && r === "auto") {
                 ...
                 I.css('left' ,248 - tWidth);

                var zmPict = I.find('.zmPict');
                 zmPict.css('margin-top', parent.height() / 2 - zmPict.height() / 2);
                ...
                var g = function (aZ, aX) {
                    var j, aY, i = aD.find(".etalage_smallthumb_active")
					...
					var currIMG = aD.find(".etalage_thumb_active");
					...
					var img = v.filter(".thumb_" + aZ.data("thumb_id")).find('.etalage_thumb_image');
					var rel = v.filter(".thumb_" + aZ.data("thumb_id")).attr('rel').split('|');
					var rel2 = currIMG.attr('rel').split('|');
					var mTOP = Number(aD.css('top').replace('px', '')) - (parent.height() / 2 - rel[1] / 2);
					
					img.css({
						'margin-left' :  (parent.width() / 2 - rel[0] / 2) - Number(aD.css('left').replace('px', '')),
						'margin-top' :  - mTOP
					});
					
										
                    j = v.filter(".thumb_" + aZ.data("thumb_id"))
                        .addClass("etalage_thumb_active")
                        .show()
                        .stop()
                        .css({
						...
						var rel = j.attr('rel').split('|');
						 
						 v.find(".etalage_thumb_image")
							.css({
							'margin-left' : 0,
							'margin-top' : 0
						}); 
						 
						tTop = parent.height() / 2 - rel[1] / 2;
							tWidth = parent.width() / 2 - rel[0] / 2;
							aD.css({
								'left' : tWidth,
								'top' : tTop
							});
						...
						var zmPict = I.find('.zmPict');
						 ...
						 /*Magnifier*/
							ak = aD.find('.etalage_zoom_preview')
								.css({
								width: rel[2],
								height: rel[3],
								opacity: 0.3
								...
								.show()
						ay = U.children(".etalage_zoom_img")
							.css({
							width: rel[2],
							height: rel[3]
						});
						  ...
						  aK = parseInt(v.css("borderLeftWidth"), 10) + parseInt(v.css("borderRightWidth"), 10) + parseInt(ar.css("borderLeftWidth"), 10) + parseInt(ar.css("borderRightWidth"), 10),
								X = parseInt(v.css("marginLeft"), 10) + parseInt(v.css("marginRight"), 10),
								A = parseInt(v.css("paddingLeft"), 10) + parseInt(v.css("paddingRight"), 10) + parseInt(ar.css("marginLeft"), 10) + parseInt(ar.css("marginRight"), 10) + parseInt(ar.css("paddingLeft"), 10) + parseInt(ar.css("paddingRight"), 10),
								L = rel[0] + aK + X + A,
								M = rel[1] + aK + X + A,
							...
							if (p > 1 || !c.smallthumb_hide_single) {
								...
								if (aC === "vert") {
									aA = Math.round((M - ((ag - 1) * N)) / ag) - (aB + au);
									ad = Math.round((rel[0] * aA) / rel[1]);
									n = ad + aB + au;
									aE = aA + aB + au
								} else {
									ad = Math.round((L - ((ag - 1) * N)) / ag) - (aB + au);
									aA = Math.round((rel[1] * ad) / rel[0]);
									n = ad + aB + au;
									aE = aA + aB + au
								}
							}
							  ...
							  var d = parseInt(I.css("borderTopWidth"), 10),
									...
									H = parseInt(I.css("paddingTop"), 10),
									R, aW;
								if ((c.zoom_area_width - (d * 2) - (H * 2)) > rel[2]) {
									R = rel[2]
								} else {
									R = c.zoom_area_width - (d * 2) - (H * 2)
								}
								...
								var T = Math.round(R * (rel[0] / rel[2])),
									P = Math.round(aW * (rel[1] / rel[3])),
									K = aH + rel[1] - P,
									o = aj + rel[0] - T,
									ac = Math.round(T / 2),
									ab = Math.round(P / 2),
               ...
               /*     aD.find('.etalage_small_thumbs ul').animate({
                        top : "-=" + aY
                    } ,aV, function () {
                        if (af) {
                ...
                var J = function () {
                    ...
                    if (!c.right_to_left) {
                        i = aD.find(".etalage_smallthumb_active")
                            .prev();
                        if (!i.length) {
                            i = aR.last()
                        }
                ...
                v.add(aL)
                    .add(D)
                    .mousemove(function (a1) {
                    var j = Math.round(a1.pageX - av.offset()
                        .left + aj),
                        i = Math.round(a1.pageY - av.offset()
                            .top + aH);
                    var a0 = (j - ac),
                        aZ = (i - ab);
                    if (a0 < aj) {
                ...
                if (p > 1 || !c.smallthumb_hide_single) {
                    aD.delegate(".etalage_smallthumb_first", "click", function () {
                        if (!af || y) {
                            ...
                            for (var aY = 0; aY < aX; aY += 1) {
                                ...
                                a4 = aD.find(".etalage_smallthumb_last")
                                    .removeClass("etalage_smallthumb_last");
                                if (a3.prev()
                                    .length) {
                                    a1 = a0.prev()
                                        .addClass("etalage_smallthumb_first");
                                    a2 = a4.prev()
                                        .addClass("etalage_smallthumb_last");
                                    aZ = a0
                                } else {
                    ...
                    aD.delegate(".etalage_smallthumb_last", "click", function () {
                        if (!af || y) {
                            ...
                            af = true;
                            for (var aY = 0; aY < aX; aY += 1) {
                                a0 = aD.find(".etalage_smallthumb_first")
