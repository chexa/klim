    ...
    protected function _getTranslateData()
    {
        if ($this->_translateData ===null) {
            $this->_translateData = array(
                ...
                'Please enter 5 or more characters. Leading or trailing spaces will be ignored.' =>
                    $this->__('Please enter 5 or more characters. Leading or trailing spaces will be ignored.'),
